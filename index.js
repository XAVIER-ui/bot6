...
Drips.hr();
console.log(color(''), color('THANKS FOR CHOOSING Xavier', 'green'))
console.log(color(''), color('SCRIPT BY DRIPS', 'red'))
console.log(color( ''), color('https://wa.me/6283181106073','cyan'))
Drips.hr();
